...
const LavnderHome = ({lavender}) => {
  ...
  <div className='outputStyle'>
      ...
      <div className='cardBlog'>
        <p>{lavender.publishedAtLavender}</p>
        <div>
        <img  src={urlFor(lavender.imageL)} alt="lavenderefield" className="footer-banner-image"/>
        </div>
        
      
        <h1>{lavender.titleLavender}</h1>
          ...
          Read more {dropBox
            ...
            {dropBox && (
              <div className='Information1' id='blogs'>
                  <PortableText value={lavender.lavenderdetails} components={components} />
...
const components = {
  types: {
    code: lavender => (
      <pre data-language={lavender.node.language}>
        <code>{lavender.node.code}</code>
      </pre>
    )
  }
}

export default LavnderHome