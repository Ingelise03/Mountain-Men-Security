...
const KalkBayStJamesHome = ({kalk}) => {
  ...
  <div className='outputStyle'>
      ...
      <div className='cardBlog'>
        <p>{kalk.publishedAtKJ}</p>
        <div>
        <img  src={urlFor(kalk.imageKJ)} alt="lavenderefield" className="footer-banner-image"/>
        </div>
          ...
          Read more {dropBox
            ...
            {dropBox && (
              <div className='Information1' id='blogs'>
                  <PortableText value={kalk.kjdetails} components={components} />
...
const components = {
  types: {
    code: kalk => (
      <pre data-language={kalk.node.language}>
        <code>{kalk.node.code}</code>
      </pre>
    )
  }
}

export default KalkBayStJamesHome