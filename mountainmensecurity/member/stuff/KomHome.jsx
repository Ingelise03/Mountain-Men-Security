...
const KomHome = ({Kom}) => {
  ...
  <div className='outputStyle'>
      ...
      <div className='cardBlog'>
        ...
        <div>
        <img  src={urlFor(Kom.imageKom)} alt="lavenderefield" className="footer-banner-image"/>
        </div>
          ...
          Read more {dropBox
            ...
            {dropBox && (
              <div className='Information1' id='blogs'>
                  <PortableText value={Kom.komdetails} components={components} />
...
const components = {
  types: {
    code: Kom => (
      <pre data-language={Kom.node.language}>
        <code>{Kom.node.code}</code>
      </pre>
    )
  }
}
