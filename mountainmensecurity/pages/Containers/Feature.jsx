...
const Features = () => {
  ...
  <div className="gpt3__features section__padding" id="features">
    ...
    <p><a className='size' tabIndex={1} href="#drop1"><h1 className="gradient__text">ABOUT MOUNTAINMEN SECURITY  {dropBox
          ? <RiCloseLine viewBox='0 -5 24 24' classNmae='size' color="#fff"  onClick={() => setDropbox(false)} />
          : <RiArrowRightLine viewBox='0 -5 24 24' classNmae='size' color="#fff"  onClick={() => setDropbox(true)} />}
        {dropBox && (
      ...
      <div className="gpt3__features-heading">
      <p><a className='size' tabIndex={1} href="#drop2"><h1 className="gradient__text"> OUR NATURE {dropBox1
          ? <RiCloseLine viewBox='0 -5 24 24' classNmae='size' color="#fff"  onClick={() => setDropbox1(false)} />
          : <RiArrowRightLine viewBox='0 -5 24 24' classNmae='size' color="#fff" onClick={() => setDropbox1(true)} />}
        {dropBox1 && (
      ...
      <div className="gpt3__features-heading">
      <p><a className='size' tabIndex={1} href="#drop3"><h1 className="gradient__text">MOUNTAIN MEN’S HISTORY {dropBox2
          ? <RiCloseLine viewBox='0 -5 24 24' classNmae='size' color="#fff"  onClick={() => setDropbox2(false)} />
          : <RiArrowRightLine viewBox='0 -5 24 24' classNmae='size' color="#fff" onClick={() => setDropbox2(true)} />}
        {dropBox2 && (
